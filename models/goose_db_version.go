...
func FindGooseDBVersionP(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) *GooseDBVersion {
...
func FindGooseDBVersionGP(ctx context.Context, iD int, selectCols ...string) *GooseDBVersion {
...
func (o *GooseDBVersion) UpsertGP(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) {
...
func (o *GooseDBVersion) UpsertP(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) {
...
func GooseDBVersionExistsP(ctx context.Context, exec boil.ContextExecutor, iD int) bool {
...
func GooseDBVersionExistsGP(ctx context.Context, iD int) bool {
