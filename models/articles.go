...
var (
	articleAllColumns            = []string{"id", "title", "content", "created_at", "updated_at", "deleted_at"}
	articleColumnsWithoutDefault = []string{"id", "title", "content", "created_at", "updated_at", "deleted_at"}
